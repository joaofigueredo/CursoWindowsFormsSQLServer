    ...
    public class Cliente
    {
        public class Unit
        {
            ...
            public Unit BuscarFicharioSQLREL(string id)
            {
                ...
                {
                    throw new Exception("Erro ao buscar conteudo do id: " + id + ex.Message);
                }
            }
            ...
            public void AlterarFicharioSQLREL()
            {
                ...
                {
                    throw new Exception("Erro ao alterar o conteúdo do identificador: " + Id + " " +ex.Message);
                }
            }
            ...
            public void ApagarFicharioSQLREL()
            {
                try
                {
                    ...
                    {
                        db.Close();
                        throw new Exception("Identificado não existente: " + this.Id);
                    }
                    else
                    {
